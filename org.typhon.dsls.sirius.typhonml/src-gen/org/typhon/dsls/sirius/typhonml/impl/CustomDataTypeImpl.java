 ...
 * </p>
 * <ul>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.CustomDataTypeImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomDataTypeImpl extends DataTypeImpl implements CustomDataType {
	...
	public EList<DataTypeItem> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<DataTypeItem>(DataTypeItem.class, this,
					TyphonmlPackage.CUSTOM_DATA_TYPE__ELEMENTS);
		}
		return elements;
	}
