...
public class TyphonmlFactoryImpl extends EFactoryImpl implements TyphonmlFactory {
	...
	public static TyphonmlFactory init() {
		try {
			TyphonmlFactory theTyphonmlFactory = (TyphonmlFactory) EPackage.Registry.INSTANCE
					.getEFactory(TyphonmlPackage.eNS_URI);
