 ...
 * </p>
 * <ul>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.RelationImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.RelationImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.RelationImpl#getOpposite <em>Opposite</em>}</li>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.RelationImpl#getIsContainment <em>Is Containment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationImpl extends NamedElementImpl implements Relation {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TyphonmlPackage.RELATION__TYPE, oldType,
							type));
			}
		}
		return type;
	...
	public void setCardinality(Cardinality newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TyphonmlPackage.RELATION__CARDINALITY, oldCardinality,
					cardinality));
	}
	...
	public Relation getOpposite() {
		if (opposite != null && opposite.eIsProxy()) {
			...
			if (opposite != oldOpposite) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TyphonmlPackage.RELATION__OPPOSITE,
	...
	public void setOpposite(Relation newOpposite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TyphonmlPackage.RELATION__OPPOSITE, oldOpposite,
					opposite));
	}
	...
	public void setIsContainment(Boolean newIsContainment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TyphonmlPackage.RELATION__IS_CONTAINMENT,
					oldIsContainment, isContainment));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case TyphonmlPackage.RELATION__IS_CONTAINMENT:
			return IS_CONTAINMENT_EDEFAULT == null ? isContainment != null
					: !IS_CONTAINMENT_EDEFAULT.equals(isContainment);
		}
