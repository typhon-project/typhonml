 ...
 * </p>
 * <ul>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.GraphNodeImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.GraphNodeImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GraphNodeImpl extends NamedElementImpl implements GraphNode {
		...
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TyphonmlPackage.GRAPH_NODE__ENTITY,
							oldEntity, entity));
			}
		}
		return entity;
	...
	public void setEntity(Entity newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TyphonmlPackage.GRAPH_NODE__ENTITY, oldEntity,
					entity));
	}
	...
	public EList<GraphAttribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<GraphAttribute>(GraphAttribute.class, this,
					TyphonmlPackage.GRAPH_NODE__ATTRIBUTES);
		}
		return attributes;
	}
