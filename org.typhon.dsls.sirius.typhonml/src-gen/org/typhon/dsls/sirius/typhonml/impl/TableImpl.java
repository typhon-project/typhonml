 ...
 * </p>
 * <ul>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.TableImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.TableImpl#getIndexSpec <em>Index Spec</em>}</li>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.TableImpl#getIdSpec <em>Id Spec</em>}</li>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.TableImpl#getDb <em>Db</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends NamedElementImpl implements Table {
		...
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TyphonmlPackage.TABLE__ENTITY, oldEntity,
							entity));
			}
		}
		return entity;
	...
	public NotificationChain basicSetIndexSpec(IndexSpec newIndexSpec, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					TyphonmlPackage.TABLE__INDEX_SPEC, oldIndexSpec, newIndexSpec);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setIndexSpec(IndexSpec newIndexSpec) {
		if (newIndexSpec != indexSpec) {
			...
			if (indexSpec != null)
				msgs = ((InternalEObject) indexSpec).eInverseRemove(this, TyphonmlPackage.INDEX_SPEC__TABLE,
						IndexSpec.class, msgs);
			if (newIndexSpec != null)
				msgs = ((InternalEObject) newIndexSpec).eInverseAdd(this, TyphonmlPackage.INDEX_SPEC__TABLE,
						IndexSpec.class, msgs);
			msgs = basicSetIndexSpec(newIndexSpec, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TyphonmlPackage.TABLE__INDEX_SPEC, newIndexSpec,
					newIndexSpec));
	}
	...
	public NotificationChain basicSetIdSpec(IdSpec newIdSpec, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					TyphonmlPackage.TABLE__ID_SPEC, oldIdSpec, newIdSpec);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setIdSpec(IdSpec newIdSpec) {
		if (newIdSpec != idSpec) {
			NotificationChain msgs = null;
			if (idSpec != null)
				msgs = ((InternalEObject) idSpec).eInverseRemove(this, TyphonmlPackage.ID_SPEC__TABLE, IdSpec.class,
						msgs);
			if (newIdSpec != null)
				msgs = ((InternalEObject) newIdSpec).eInverseAdd(this, TyphonmlPackage.ID_SPEC__TABLE, IdSpec.class,
						msgs);
			msgs = basicSetIdSpec(newIdSpec, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TyphonmlPackage.TABLE__ID_SPEC, newIdSpec,
					newIdSpec));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case TyphonmlPackage.TABLE__INDEX_SPEC:
			if (indexSpec != null)
				msgs = ((InternalEObject) indexSpec).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - TyphonmlPackage.TABLE__INDEX_SPEC, null, msgs);
			return basicSetIndexSpec((IndexSpec) otherEnd, msgs);
		case TyphonmlPackage.TABLE__ID_SPEC:
			if (idSpec != null)
				msgs = ((InternalEObject) idSpec).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - TyphonmlPackage.TABLE__ID_SPEC, null, msgs);
