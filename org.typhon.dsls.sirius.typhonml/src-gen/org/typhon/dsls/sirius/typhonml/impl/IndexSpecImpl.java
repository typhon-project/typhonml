 ...
 * </p>
 * <ul>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.IndexSpecImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.IndexSpecImpl#getReferences <em>References</em>}</li>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.IndexSpecImpl#getTable <em>Table</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndexSpecImpl extends NamedElementImpl implements IndexSpec {
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectResolvingEList<Attribute>(Attribute.class, this,
					TyphonmlPackage.INDEX_SPEC__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public EList<Relation> getReferences() {
		if (references == null) {
			references = new EObjectResolvingEList<Relation>(Relation.class, this,
					TyphonmlPackage.INDEX_SPEC__REFERENCES);
		}
		return references;
	}
	...
	public Table getTable() {
		if (eContainerFeatureID() != TyphonmlPackage.INDEX_SPEC__TABLE)
			return null;
	...
	public void setTable(Table newTable) {
		if (newTable != eInternalContainer()
				|| (eContainerFeatureID() != TyphonmlPackage.INDEX_SPEC__TABLE && newTable != null)) {
			...
			if (newTable != null)
				msgs = ((InternalEObject) newTable).eInverseAdd(this, TyphonmlPackage.TABLE__INDEX_SPEC, Table.class,
						msgs);
			msgs = basicSetTable(newTable, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TyphonmlPackage.INDEX_SPEC__TABLE, newTable,
					newTable));
	}
