 ...
 * </p>
 * <ul>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.GraphEdgeImpl#getFrom <em>From</em>}</li>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.GraphEdgeImpl#getTo <em>To</em>}</li>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.GraphEdgeImpl#getLabels <em>Labels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GraphEdgeImpl extends NamedElementImpl implements GraphEdge {
		...
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TyphonmlPackage.GRAPH_EDGE__FROM, oldFrom,
							from));
			}
		}
		return from;
	...
	public GraphNode getTo() {
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TyphonmlPackage.GRAPH_EDGE__TO, oldTo,
							to));
			}
		}
		return to;
	...
	public EList<GraphEdgeLabel> getLabels() {
		if (labels == null) {
			labels = new EObjectContainmentEList<GraphEdgeLabel>(GraphEdgeLabel.class, this,
					TyphonmlPackage.GRAPH_EDGE__LABELS);
		}
		return labels;
	}
