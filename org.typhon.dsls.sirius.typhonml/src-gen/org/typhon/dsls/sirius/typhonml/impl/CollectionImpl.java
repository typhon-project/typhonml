 ...
 * </p>
 * <ul>
 *   <li>{@link org.typhon.dsls.sirius.typhonml.impl.CollectionImpl#getEntity <em>Entity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionImpl extends NamedElementImpl implements Collection {
		...
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TyphonmlPackage.COLLECTION__ENTITY,
							oldEntity, entity));
			}
		}
		return entity;
	...
	public void setEntity(Entity newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TyphonmlPackage.COLLECTION__ENTITY, oldEntity,
					entity));
	}
