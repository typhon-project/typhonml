...
/**
 * This is the item provider adapter for a {@link org.typhon.dsls.sirius.typhonml.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider extends NamedElementItemProvider {
	...
	protected void addEntityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Table_entity_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Table_entity_feature", "_UI_Table_type"),
						TyphonmlPackage.Literals.TABLE__ENTITY, true, false, true, null, null, null));
	}
	...
	protected void addDbPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Table_db_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Table_db_feature", "_UI_Table_type"),
						TyphonmlPackage.Literals.TABLE__DB, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TyphonmlPackage.Literals.TABLE__INDEX_SPEC);
			childrenFeatures.add(TyphonmlPackage.Literals.TABLE__ID_SPEC);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(TyphonmlPackage.Literals.TABLE__INDEX_SPEC,
				TyphonmlFactory.eINSTANCE.createIndexSpec()));

		newChildDescriptors.add(createChildParameter(TyphonmlPackage.Literals.TABLE__ID_SPEC,
				TyphonmlFactory.eINSTANCE.createIdSpec()));
	}
