...
/**
 * This is the item provider adapter for a {@link org.typhon.dsls.sirius.typhonml.Collection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CollectionItemProvider extends NamedElementItemProvider {
	...
	protected void addEntityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Collection_entity_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Collection_entity_feature",
								"_UI_Collection_type"),
						TyphonmlPackage.Literals.COLLECTION__ENTITY, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Collection_type")
