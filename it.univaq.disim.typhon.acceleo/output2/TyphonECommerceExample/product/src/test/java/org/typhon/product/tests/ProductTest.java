package org.typhon.product.tests;
...
import org.typhon.product.model.repository.ProductRepository;
...
public class ProductTest {
	...
	public void shouldQueryEntity() throws Exception {
		...
		mockMvc.perform(
				get("/product/search/findByLastName?name={name}", "Baggins")).andExpect(
