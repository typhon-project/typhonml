package org.typhon.comment.tests;
...
import org.typhon.comment.model.repository.CommentRepository;
...
public class CommentTest {
	...
	public void shouldCreateEntity() throws Exception {
		...
		mockMvc.perform(post("/comment").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
						status().isCreated()).andExpect(
								header().string("Location", containsString("comment/")));
	}

	@Test
	public void shouldRetrieveEntity() throws Exception {

		MvcResult mvcResult = mockMvc.perform(post("/comment").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
	...
	public void shouldQueryEntity() throws Exception {
		...
		mockMvc.perform(
				get("/comment/search/findByLastName?name={name}", "Baggins")).andExpect(
