...
public class TyphonMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TyphonMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCustomDataTypeItemAccess().getGroup(), "rule__CustomDataTypeItem__Group__0");
			builder.put(grammarAccess.getCustomDataTypeItemAccess().getGroup_0(), "rule__CustomDataTypeItem__Group_0__0");
			...
			builder.put(grammarAccess.getModelAccess().getCustomDataTypesAssignment_2(), "rule__Model__CustomDataTypesAssignment_2");
			...
			builder.put(grammarAccess.getCustomDataTypeItemAccess().getImportedNamespaceAssignment_0_1(), "rule__CustomDataTypeItem__ImportedNamespaceAssignment_0_1");
			builder.put(grammarAccess.getCustomDataTypeItemAccess().getNameAssignment_1(), "rule__CustomDataTypeItem__NameAssignment_1");
			builder.put(grammarAccess.getCustomDataTypeItemAccess().getTypeAssignment_3(), "rule__CustomDataTypeItem__TypeAssignment_3");
			builder.put(grammarAccess.getCustomDataTypeItemAccess().getImplementationAssignment_5(), "rule__CustomDataTypeItem__ImplementationAssignment_5");
