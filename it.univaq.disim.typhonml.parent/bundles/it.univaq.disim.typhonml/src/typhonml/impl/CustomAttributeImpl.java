 ...
 * </p>
 * <ul>
 *   <li>{@link typhonml.impl.CustomAttributeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomAttributeImpl extends EntityAttributeKindImpl implements CustomAttribute {
	...
	protected EClass eStaticClass() {
		return TyphonmlPackage.Literals.CUSTOM_ATTRIBUTE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TyphonmlPackage.CUSTOM_ATTRIBUTE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(CustomDataType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TyphonmlPackage.CUSTOM_ATTRIBUTE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TyphonmlPackage.CUSTOM_ATTRIBUTE__TYPE:
