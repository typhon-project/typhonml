...
public class AddCustomDataTypeAttributeImpl extends AddAttributeImpl implements AddCustomDataTypeAttribute {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CustomDataTypeAttribute.class) {
			switch (derivedFeatureID) {
				case TyphonmlPackage.ADD_CUSTOM_DATA_TYPE_ATTRIBUTE__TYPE: return TyphonmlPackage.CUSTOM_DATA_TYPE_ATTRIBUTE__TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CustomDataTypeAttribute.class) {
			switch (baseFeatureID) {
				case TyphonmlPackage.CUSTOM_DATA_TYPE_ATTRIBUTE__TYPE: return TyphonmlPackage.ADD_CUSTOM_DATA_TYPE_ATTRIBUTE__TYPE;
				default: return -1;
			}
		}
