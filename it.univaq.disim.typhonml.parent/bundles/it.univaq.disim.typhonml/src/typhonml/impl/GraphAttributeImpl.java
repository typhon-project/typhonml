 ...
 * </p>
 * <ul>
 *   <li>{@link typhonml.impl.GraphAttributeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GraphAttributeImpl extends NamedElementImpl implements GraphAttribute {
		...
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TyphonmlPackage.GRAPH_ATTRIBUTE__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(Attribute newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TyphonmlPackage.GRAPH_ATTRIBUTE__VALUE, oldValue, value));
	}
