package it.univaq.disim.typhonml.repository;
...
public class TyphonMLSimpleUsage {
	private static final String COMPLETE_MODEL_PATH = "repository/test/generated_demo.xmi";
	private static final String COMPLETE_TML_PATH = "repository/test/my.tml";
	final private static ResourceSet resourceSet = new ResourceSetImpl();
	
	
	public TyphonMLSimpleUsage() {
	...
	public static void main(String[] args) {
		TyphonMLSimpleUsage usageExample = new TyphonMLSimpleUsage();
