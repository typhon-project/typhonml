...
/**
 * This is the item provider adapter for a {@link typhonml.AddGraphEdge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddGraphEdgeItemProvider extends ChangeOperatorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AddGraphEdgeItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addFromPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GraphEdge_from_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GraphEdge_from_feature", "_UI_GraphEdge_type"),
				 TyphonmlPackage.Literals.GRAPH_EDGE__FROM,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TyphonmlPackage.Literals.GRAPH_EDGE__LABELS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AddGraphEdge"));
	}
