...
/**
 * This is the item provider adapter for a {@link typhonml.KeyValueElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_KeyValueElement_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_KeyValueElement_key_feature", "_UI_KeyValueElement_type"),
				 TyphonmlPackage.Literals.KEY_VALUE_ELEMENT__KEY,
				 true,
				 false,
				 false,
