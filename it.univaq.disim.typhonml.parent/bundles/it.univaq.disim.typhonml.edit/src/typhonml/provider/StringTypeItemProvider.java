...
/**
 * This is the item provider adapter for a {@link typhonml.StringType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringTypeItemProvider extends PrimitiveDataTypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringType_maxSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringType_maxSize_feature", "_UI_StringType_type"),
				 TyphonmlPackage.Literals.STRING_TYPE__MAX_SIZE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_StringType_type") + " " + stringType.getMaxSize();
	}
