...
public class UserServiceTest {
	...
	public void init() {
		...
		ordersService = new OrderService("http://localhost:8080");
		commentsService = new CommentService("http://localhost:8080");
		reviewsService = new ReviewService("http://localhost:8080");
	}
