package org.typhon.order.tests;
...
import org.typhon.order.model.repository.OrderRepository;
...
public class OrderTest {
	...
	public void shouldRetrieveEntity() throws Exception {
		...
		MvcResult mvcResult = mockMvc.perform(post("/order").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
	...
	public void shouldQueryEntity() throws Exception {
		...
		mockMvc.perform(
				get("/order/search/findByLastName?name={name}", "Baggins")).andExpect(
