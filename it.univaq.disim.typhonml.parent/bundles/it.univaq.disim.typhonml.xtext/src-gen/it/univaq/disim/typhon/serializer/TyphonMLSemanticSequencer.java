...
public class TyphonMLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *     EntityAttributeKind returns Attribute
	...
	/**
	 * Contexts:
	 *     SuperDataType returns ComplexDataType
	...
	/**
	 * Contexts:
	 *     EntityAttributeKind returns CustomAttribute
	 ...
	 *
	 * Constraint:
	 *     (customDataTypes+=CustomDataType* entities+=Entity* databases+=Database* (changeOperators+=ChangeOperator changeOperators+=ChangeOperator*)?)
	 */
	...
	/**
	 * Contexts:
	 *     SuperDataType returns SimpleDataType
	...
	protected void sequence_SimpleDataType(ISerializationContext context, SimpleDataType semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TyphonmlPackage.Literals.NAMED_ELEMENT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TyphonmlPackage.Literals.NAMED_ELEMENT__NAME));
			if (transientValues.isValueTransient(semanticObject, TyphonmlPackage.Literals.SIMPLE_DATA_TYPE__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TyphonmlPackage.Literals.SIMPLE_DATA_TYPE__TYPE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSimpleDataTypeAccess().getNameEStringParserRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getSimpleDataTypeAccess().getTypeDataTypeParserRuleCall_3_0(), semanticObject.getType());
		feeder.finish();
	}
