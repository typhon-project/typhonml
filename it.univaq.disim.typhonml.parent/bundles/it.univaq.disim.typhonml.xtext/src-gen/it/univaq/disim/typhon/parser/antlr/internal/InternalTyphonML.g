...
entryRuleSuperDataType returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSuperDataTypeRule()); }
	iv_ruleSuperDataType=ruleSuperDataType
	{ $current=$iv_ruleSuperDataType.current; }
	EOF;

// Rule SuperDataType
ruleSuperDataType returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_ComplexDataType_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRuleEntityAttributeKind returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEntityAttributeKindRule()); }
	iv_ruleEntityAttributeKind=ruleEntityAttributeKind
	{ $current=$iv_ruleEntityAttributeKind.current; }
	EOF;

// Rule EntityAttributeKind
ruleEntityAttributeKind returns [EObject current=null]
@init {
	enterRule();
}
@after {
