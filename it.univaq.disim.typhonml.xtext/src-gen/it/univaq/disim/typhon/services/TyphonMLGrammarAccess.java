...
public class TyphonMLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DocumentDBCollectionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.univaq.disim.typhon.TyphonML.DocumentDBCollection");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.univaq.disim.typhon.TyphonML.Node");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EdgeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.univaq.disim.typhon.TyphonML.Edge");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PrimitiveDataTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.univaq.disim.typhon.TyphonML.PrimitiveDataType");
		private final Group cGroup = (Group)rule.eContents().get(1);
