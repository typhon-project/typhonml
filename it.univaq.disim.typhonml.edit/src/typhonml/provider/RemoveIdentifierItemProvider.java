		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RemoveIdentifier_entity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RemoveIdentifier_entity_feature", "_UI_RemoveIdentifier_type"),
				 TyphonmlPackage.Literals.REMOVE_IDENTIFIER__ENTITY,
				 true,
				 false,
				 true,
				 null,
