...
/**
 * This is the item provider adapter for a {@link typhonml.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TyphonmlPackage.Literals.RELATION__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCardinalityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relation_cardinality_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relation_cardinality_feature", "_UI_Relation_type"),
				 TyphonmlPackage.Literals.RELATION__CARDINALITY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TyphonmlPackage.Literals.RELATION__OPPOSITE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIsContainmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relation_isContainment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relation_isContainment_feature", "_UI_Relation_type"),
				 TyphonmlPackage.Literals.RELATION__IS_CONTAINMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
