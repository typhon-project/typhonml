		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RenameAttribute_attributeToRemove_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RenameAttribute_attributeToRemove_feature", "_UI_RenameAttribute_type"),
				 TyphonmlPackage.Literals.RENAME_ATTRIBUTE__ATTRIBUTE_TO_REMOVE,
				 true,
				 false,
				 true,
				 null,
